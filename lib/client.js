...
export default function wasmWorkerAPI (worker, functions) {
  if (!(worker instanceof Worker))
    throw new TypeError('worker should be an instance of the Worker')
  ...
  const ready = handleMessage(getCurrentId(), (resolve, data) => {
  ...
  function getCurrentId () {
    return `${secret}-${pingPongMsgCounter}`
  }
  ...
  function handleMessage (id, callback) {
